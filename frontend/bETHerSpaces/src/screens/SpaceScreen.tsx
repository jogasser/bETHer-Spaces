    ...
    const lastMeasurement = space.measurements != null && space.measurements.length > 0 ?
      <View>
        <View style={styles.measurement}>
          ...
          <Text>{space.measurements[space.measurements.length - 1 ].temperature}</Text>
        </View>
        <View style={styles.measurement}>
          <Text>Pressure: </Text>
          <Text>{space.measurements[space.measurements.length - 1 ].pressure}</Text>
        </View>
        <View style={styles.measurement}>
          <Text>Light level: </Text>
          <Text>{space.measurements[space.measurements.length - 1 ].light}</Text>
        </View>
        <View style={styles.measurement}>
          <Text>Humidity: </Text>
          <Text>{space.measurements[space.measurements.length - 1 ].humidity}</Text>
        </View>
        <Subheading>Air Quality: </Subheading>
        <View style={styles.measurement}>
          <Text>Oxidation: </Text>
          <Text>{space.measurements[space.measurements.length - 1 ].oxidised}</Text>
        </View>
        <View style={styles.measurement}>
          <Text>NH3 Level: </Text>
          <Text>{space.measurements[space.measurements.length - 1 ].nh3}</Text>
        </View>
        <View style={styles.measurement}>
          <Text>PM1 Level: </Text>
          <Text>{space.measurements[space.measurements.length - 1 ].pm1}</Text>
        </View>
        <View style={styles.measurement}>
          <Text>PM10 Level: </Text>
          <Text>{space.measurements[space.measurements.length - 1 ].pm10}</Text>
        </View>
        <View style={styles.measurement}>
          <Text>PM 25 Level: </Text>
          <Text>{space.measurements[space.measurements.length - 1 ].pm25}</Text>
        </View>
      </View> :
    ...
    return (
      <View>
        ...
        <View style={styles.wrapper}>
          ...
          <View style={styles.column}>
            <Subheading>Last Measurements: </Subheading>
            {lastMeasurement}
          </View>
          <View style={styles.column}>
            <LineChart
